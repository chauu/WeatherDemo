package com.demo.weather.module.place.view

import android.view.View
import androidx.recyclerview.widget.StaggeredGridLayoutManager
import com.demo.weather.R
import com.demo.weather.base.view.BaseLifeCycleFragment
import com.demo.weather.module.place.adapter.ChoosePlaceAdapter
import com.demo.weather.module.place.viewmodel.ChoosePlaceViewModel
...
class ChoosePlaceFragment : BaseLifeCycleFragment<ChoosePlaceViewModel>(){
    ...
    private fun initHeaderView() {
        ...
        mHeaderView.apply {
            ...
            detail_end.setImageResource(R.drawable.ic_delete)
